...
- Every display uses one chronological recording list, with compact archive totals and space-conscious headers. Searching or filtering puts results first and hides the global summary.
